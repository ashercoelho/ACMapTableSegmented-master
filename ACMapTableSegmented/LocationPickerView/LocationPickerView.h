...
/** This GMSMapViewDelegate is forwarded to the LocationPickers's
 GMSMapView when it is created. */
@property (nonatomic, weak) IBOutlet id<GMSMapViewDelegate> mapViewDelegate;
...
- (void)locationPicker:(LocationPickerView *)locationPicker
     mapViewDidLoad:(GMSMapView *)mapView;
