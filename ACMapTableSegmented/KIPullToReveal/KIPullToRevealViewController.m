...
{
    if(_pullToRevealDelegate && [_pullToRevealDelegate respondsToSelector:@selector(segmentedControlIndexChanged)])
        [self.pullToRevealDelegate segmentedControlIndexChanged];
}
